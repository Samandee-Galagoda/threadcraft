...
MEASUREMENT_FIELDS = {
    ...
    "trousers": [
        ...
        ("leg_opening", "Leg opening", "G", 25, 60, False, "Around the hem."),
    ],
    "kurta": [
        (
            "chest",
    ...
    "saree-blouse": [
        ("bust", "Bust", "A", 65, 140, True, "Around the fullest part of your chest."),
        (
            "waist",
            "Waist",
            "B",
        ...
        ("shoulder", "Shoulder width", "C", 28, 58, False, "Shoulder bone tip to tip."),
        (
            "sleeve",
            "Sleeve length",
            "D",
    ...
    "salwar-kameez": [
        ("bust", "Bust", "A", 65, 145, True, "Around the fullest part of your chest."),
        ("waist", "Waist", "B", 50, 130, False, "Around your natural waist."),
        ("hip", "Hip", "C", 70, 155, False, "Around the fullest part of your hips."),
        (
            "kameez_length",
            "Kameez length",
            "D",
